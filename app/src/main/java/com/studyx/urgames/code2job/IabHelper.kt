...
(ctx: Context, base64PublicKey: String) {
    ...
    internal lateinit var mPurchasingItemType: String
     ...
     */
    @Throws(IabHelper.IabAsyncInProgressException::class)
    fun dispose() {
    ...
    fun handleActivityResult(requestCode: Int, resultCode: Int, data: Intent?): Boolean {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            try {
                ...
                // Verify signature
                if (!Security.verifyPurchase(mSignatureBase64.toString(), purchaseData, dataSignature)) {
    ...
    internal fun getResponseCodeFromBundle(b: Bundle?): Int {
        ...
        if (o == null) {
            ...
            logError(o.javaClass.getName())
            throw RuntimeException("Unexpected type for bundle response code: " + o.javaClass.getName())
        }
    }
    ...
    internal fun getResponseCodeFromIntent(i: Intent): Int {
        ...
        if (o == null) {
            ...
            logError(o.javaClass.getName())
            throw RuntimeException("Unexpected type for intent response code: " + o.javaClass.getName())
        }
    }
    ...
    internal fun queryPurchases(inv: Inventory, itemType: String): Int {
        ...
        do {
            ...
            for (i in purchaseDataList!!.indices) {
                ...
                val sku = ownedSkus!![i]
                if (Security.verifyPurchase(mSignatureBase64.toString(), purchaseData, signature)) {
    ...
    companion object {
        ...
        val IABHELPER_SUBSCRIPTION_UPDATE_NOT_AVAILABLE = -1011
