...
class sample_paper : Activity(), ActivityCompat.OnRequestPermissionsResultCallback, View.OnTouchListener {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnNext.setOnClickListener { showPage(currentPage!!.index + 1) }
