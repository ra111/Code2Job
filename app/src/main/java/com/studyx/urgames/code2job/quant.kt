...
import com.studyx.urgames.code2job.quant_ques.Companion.answers
import com.studyx.urgames.code2job.quant_ques.Companion.questions

/**
 * Created by rahula on 11/03/18.
 */

class quant : AppCompatActivity() {
