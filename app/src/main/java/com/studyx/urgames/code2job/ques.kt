...
class ques {
    ...
    companion object {
        ...
        var answers = arrayOf("Lot of candidates get confused between percentile to percentage. They are vastly different and a brief explanation is below.\n" +
                ...
                "\n" +
                "You can go to Tests -->Scores section to view the score.", "In case you were unable to attend the pH test despite having received an admit card, you would be eligible to get a discount code of Rs.500.\n" +
                ...
                "Once your original documents are verified your score would be released within 2 weeks.", "Though there is no eligibility criteria for writing the pH test, companies may have their own criteria pertaining to backlogs. We would therefore, suggest you to clear your backlogs before taking the pH test or at least before applying for companies.")
    }
}
